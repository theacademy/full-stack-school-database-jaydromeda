...
public class StudentDaoImpl implements StudentDao {
    ...
    public void deleteStudent(int id) {
        ...
        // Remove from course_student bridge table first to avoid FK issues
        final String deleteBridge = "DELETE FROM course_student WHERE student_id = ?";
        jdbcTemplate.update(deleteBridge, id);
